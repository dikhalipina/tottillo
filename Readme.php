...
<meta name="keywords" content="accessibility, web design, coding, programing" />
					...
					<tbody>
						<tr>
							...
							<td colspan="2" style="vertical-align: top; padding-top:5px;">
									<input type="hidden" name="ftpserver" value="ftp.cluster031.hosting.ovh.net" />
									<b>ftp.cluster031.hosting.ovh.net</b>
						...
						<tr style="vertical-align: middle;"> 
							...
							<td style="width: 46%;"><input name="username" value="lpnsyrv" type="text" style="width:230px;" /></td>
...
<!--
						<tr style="vertical-align: middle;"> 
							...
							<td><input name="directory" value="/www" type="text" style="width:230px;" /></td>
